...
static const _ChannelInfo_type_support_symbol_names_t _ChannelInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, elevation_map_msgs, msg, ChannelInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, elevation_map_msgs, msg, ChannelInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, elevation_map_msgs, msg, ChannelInfo)() {
  return &::elevation_map_msgs::msg::rosidl_typesupport_c::ChannelInfo_message_type_support_handle;
}
