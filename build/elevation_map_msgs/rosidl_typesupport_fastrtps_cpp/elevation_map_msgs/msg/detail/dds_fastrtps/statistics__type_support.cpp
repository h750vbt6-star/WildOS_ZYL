...
#include "elevation_map_msgs/msg/detail/statistics__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = elevation_map_msgs::msg::Statistics;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const elevation_map_msgs::msg::Statistics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<elevation_map_msgs::msg::Statistics *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Statistics__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const elevation_map_msgs::msg::Statistics *>(
...
static size_t _Statistics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Statistics(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Statistics__callbacks = {
...
static rosidl_message_type_support_t _Statistics__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Statistics__callbacks,
...
{
  return &elevation_map_msgs::msg::typesupport_fastrtps_cpp::_Statistics__handle;
}
