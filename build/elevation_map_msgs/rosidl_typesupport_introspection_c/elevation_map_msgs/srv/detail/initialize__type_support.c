...
void elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  elevation_map_msgs__srv__Initialize_Event__init(message_memory);
}

void elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_fini_function(void * message_memory)
{
  elevation_map_msgs__srv__Initialize_Event__fini(message_memory);
}

size_t elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__size_function__Initialize_Event__request(
  const void * untyped_member)
{
  const elevation_map_msgs__srv__Initialize_Request__Sequence * member =
    (const elevation_map_msgs__srv__Initialize_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_const_function__Initialize_Event__request(
  const void * untyped_member, size_t index)
{
  const elevation_map_msgs__srv__Initialize_Request__Sequence * member =
    (const elevation_map_msgs__srv__Initialize_Request__Sequence *)(untyped_member);
...
void * elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_function__Initialize_Event__request(
  void * untyped_member, size_t index)
{
  elevation_map_msgs__srv__Initialize_Request__Sequence * member =
    (elevation_map_msgs__srv__Initialize_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__fetch_function__Initialize_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const elevation_map_msgs__srv__Initialize_Request * item =
    ((const elevation_map_msgs__srv__Initialize_Request *)
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_const_function__Initialize_Event__request(untyped_member, index));
  elevation_map_msgs__srv__Initialize_Request * value =
    (elevation_map_msgs__srv__Initialize_Request *)(untyped_value);
  *value = *item;
}

void elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__assign_function__Initialize_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  elevation_map_msgs__srv__Initialize_Request * item =
    ((elevation_map_msgs__srv__Initialize_Request *)
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_function__Initialize_Event__request(untyped_member, index));
  const elevation_map_msgs__srv__Initialize_Request * value =
    (const elevation_map_msgs__srv__Initialize_Request *)(untyped_value);
  *item = *value;
}

bool elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__resize_function__Initialize_Event__request(
  void * untyped_member, size_t size)
{
  elevation_map_msgs__srv__Initialize_Request__Sequence * member =
    (elevation_map_msgs__srv__Initialize_Request__Sequence *)(untyped_member);
  elevation_map_msgs__srv__Initialize_Request__Sequence__fini(member);
  return elevation_map_msgs__srv__Initialize_Request__Sequence__init(member, size);
}

size_t elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__size_function__Initialize_Event__response(
  const void * untyped_member)
{
  const elevation_map_msgs__srv__Initialize_Response__Sequence * member =
    (const elevation_map_msgs__srv__Initialize_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_const_function__Initialize_Event__response(
  const void * untyped_member, size_t index)
{
  const elevation_map_msgs__srv__Initialize_Response__Sequence * member =
    (const elevation_map_msgs__srv__Initialize_Response__Sequence *)(untyped_member);
...
void * elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_function__Initialize_Event__response(
  void * untyped_member, size_t index)
{
  elevation_map_msgs__srv__Initialize_Response__Sequence * member =
    (elevation_map_msgs__srv__Initialize_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__fetch_function__Initialize_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const elevation_map_msgs__srv__Initialize_Response * item =
    ((const elevation_map_msgs__srv__Initialize_Response *)
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_const_function__Initialize_Event__response(untyped_member, index));
  elevation_map_msgs__srv__Initialize_Response * value =
    (elevation_map_msgs__srv__Initialize_Response *)(untyped_value);
  *value = *item;
}

void elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__assign_function__Initialize_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  elevation_map_msgs__srv__Initialize_Response * item =
    ((elevation_map_msgs__srv__Initialize_Response *)
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_function__Initialize_Event__response(untyped_member, index));
  const elevation_map_msgs__srv__Initialize_Response * value =
    (const elevation_map_msgs__srv__Initialize_Response *)(untyped_value);
  *item = *value;
}

bool elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__resize_function__Initialize_Event__response(
  void * untyped_member, size_t size)
{
  elevation_map_msgs__srv__Initialize_Response__Sequence * member =
    (elevation_map_msgs__srv__Initialize_Response__Sequence *)(untyped_member);
  elevation_map_msgs__srv__Initialize_Response__Sequence__fini(member);
  return elevation_map_msgs__srv__Initialize_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(elevation_map_msgs__srv__Initialize_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(elevation_map_msgs__srv__Initialize_Event, request),  // bytes offset in struct
    NULL,  // default value
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__size_function__Initialize_Event__request,  // size() function pointer
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_const_function__Initialize_Event__request,  // get_const(index) function pointer
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_function__Initialize_Event__request,  // get(index) function pointer
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__fetch_function__Initialize_Event__request,  // fetch(index, &value) function pointer
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__assign_function__Initialize_Event__request,  // assign(index, value) function pointer
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__resize_function__Initialize_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(elevation_map_msgs__srv__Initialize_Event, response),  // bytes offset in struct
    NULL,  // default value
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__size_function__Initialize_Event__response,  // size() function pointer
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_const_function__Initialize_Event__response,  // get_const(index) function pointer
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__get_function__Initialize_Event__response,  // get(index) function pointer
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__fetch_function__Initialize_Event__response,  // fetch(index, &value) function pointer
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__assign_function__Initialize_Event__response,  // assign(index, value) function pointer
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__resize_function__Initialize_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_members = {
  "elevation_map_msgs__srv",  // message namespace
  "Initialize_Event",  // message name
  3,  // number of fields
  sizeof(elevation_map_msgs__srv__Initialize_Event),
  false,  // has_any_key_member_
  elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_member_array,  // message members
  elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_type_support_handle = {
  0,
  &elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_elevation_map_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, elevation_map_msgs, srv, Initialize_Event)() {
  elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, elevation_map_msgs, srv, Initialize_Request)();
  elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, elevation_map_msgs, srv, Initialize_Response)();
  if (!elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_type_support_handle.typesupport_identifier) {
    elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t elevation_map_msgs__srv__detail__initialize__rosidl_typesupport_introspection_c__Initialize_service_type_support_handle = {
  ...
  &elevation_map_msgs__srv__Initialize_Request__rosidl_typesupport_introspection_c__Initialize_Request_message_type_support_handle,
  &elevation_map_msgs__srv__Initialize_Response__rosidl_typesupport_introspection_c__Initialize_Response_message_type_support_handle,
  &elevation_map_msgs__srv__Initialize_Event__rosidl_typesupport_introspection_c__Initialize_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, elevation_map_msgs, srv, Initialize_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, elevation_map_msgs, srv, Initialize_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, elevation_map_msgs, srv, Initialize_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_elevation_map_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, elevation_map_msgs, srv, Initialize)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, elevation_map_msgs, srv, Initialize_Event)()->data;
  }
