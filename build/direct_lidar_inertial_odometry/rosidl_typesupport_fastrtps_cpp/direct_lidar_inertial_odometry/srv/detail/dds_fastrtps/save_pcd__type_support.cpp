...
// functions for direct_lidar_inertial_odometry::srv::SavePCD_Request already declared above

// functions for direct_lidar_inertial_odometry::srv::SavePCD_Response already declared above
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      direct_lidar_inertial_odometry::srv::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  direct_lidar_inertial_odometry::srv::SavePCD_Event & ros_message)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      direct_lidar_inertial_odometry::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        direct_lidar_inertial_odometry::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        direct_lidar_inertial_odometry::srv::typesupport_fastrtps_cpp::max_serialized_size_SavePCD_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        direct_lidar_inertial_odometry::srv::typesupport_fastrtps_cpp::max_serialized_size_SavePCD_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = direct_lidar_inertial_odometry::srv::SavePCD_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      direct_lidar_inertial_odometry::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        direct_lidar_inertial_odometry::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        direct_lidar_inertial_odometry::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SavePCD_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        direct_lidar_inertial_odometry::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SavePCD_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const direct_lidar_inertial_odometry::srv::SavePCD_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<direct_lidar_inertial_odometry::srv::SavePCD_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SavePCD_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const direct_lidar_inertial_odometry::srv::SavePCD_Event *>(
...
static size_t _SavePCD_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SavePCD_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SavePCD_Event__callbacks = {
  "direct_lidar_inertial_odometry::srv",
  "SavePCD_Event",
...
static rosidl_message_type_support_t _SavePCD_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SavePCD_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &direct_lidar_inertial_odometry::srv::typesupport_fastrtps_cpp::_SavePCD_Event__handle;
}
...
static const rosidl_service_type_support_t _SavePCD__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SavePCD__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<direct_lidar_inertial_odometry::srv::SavePCD_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<direct_lidar_inertial_odometry::srv::SavePCD_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<direct_lidar_inertial_odometry::srv::SavePCD_Event>(),
