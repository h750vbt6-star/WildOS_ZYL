...
static const _NavSatFixArray_type_support_symbol_names_t _NavSatFixArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gps_visualization, msg, NavSatFixArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gps_visualization, msg, NavSatFixArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gps_visualization, msg, NavSatFixArray)() {
  return &::gps_visualization::msg::rosidl_typesupport_c::NavSatFixArray_message_type_support_handle;
}
