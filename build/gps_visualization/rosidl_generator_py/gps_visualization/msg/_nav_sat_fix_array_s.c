...
bool gps_visualization__msg__nav_sat_fix_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gps_visualization.msg._nav_sat_fix_array.NavSatFixArray", full_classname_dest, 55) == 0);
  }
  gps_visualization__msg__NavSatFixArray * ros_message = _ros_message;
  {  // gps_fixes
    PyObject * field = PyObject_GetAttrString(_pymsg, "gps_fixes");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'gps_fixes'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    sensor_msgs__msg__NavSatFix * dest = ros_message->gps_fixes.data;
...
PyObject * gps_visualization__msg__nav_sat_fix_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gps_visualization.msg._nav_sat_fix_array");
  ...
  {  // gps_fixes
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->gps_fixes.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "gps_fixes", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
