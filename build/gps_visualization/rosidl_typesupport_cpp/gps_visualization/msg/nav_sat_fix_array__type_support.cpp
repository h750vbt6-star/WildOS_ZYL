...
static const _NavSatFixArray_type_support_symbol_names_t _NavSatFixArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gps_visualization, msg, NavSatFixArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gps_visualization, msg, NavSatFixArray)),
  }
};
...
{
  return &::gps_visualization::msg::rosidl_typesupport_cpp::NavSatFixArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gps_visualization, msg, NavSatFixArray)() {
  return get_message_type_support_handle<gps_visualization::msg::NavSatFixArray>();
}
