...
static const _ObjectMaskWithTf_type_support_symbol_names_t _ObjectMaskWithTf_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_search_msgs, msg, ObjectMaskWithTf)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, object_search_msgs, msg, ObjectMaskWithTf)),
  }
};
...
{
  return &::object_search_msgs::msg::rosidl_typesupport_cpp::ObjectMaskWithTf_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, object_search_msgs, msg, ObjectMaskWithTf)() {
  return get_message_type_support_handle<object_search_msgs::msg::ObjectMaskWithTf>();
}
